...
class CustomButton(
    ...
    private val imagesResId: Int,
    private val color : Int,
    private val listener : CustomButtonListener
) {
    ...
    fun onDraw(c: Canvas, rectF : RectF, post: Int) {
        ...
        if (imagesResId == 0) {
            ...
            c.drawText(text, rectF.left,rectF.top+y,p)
        } else {
            val d = ContextCompat.getDrawable(context, imagesResId)
